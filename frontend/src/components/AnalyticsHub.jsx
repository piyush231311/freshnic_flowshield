...
import { 
  ...
  Droplets, Users, ArrowUpDown, ChevronRight, Eye 
} from 'lucide-react';
...
function AnalyticsHub({
  ...
  }, [timesMin, selectedWardId, regionData, regionDepth, regionAffected, regionStatus]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/90 rounded-2xl border border-teal-500/30 p-4 sm:p-6 shadow-2xl backdrop-blur-md">
        ...
        {/* Hydrograph Header & Ward Selector */}
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-lg font-bold font-mono text-white tracking-wide">
                WARD HYDROGRAPH // DEPTH TIME-SERIES
              </h2>
            </div>
